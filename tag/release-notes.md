...
description: Release notes dan changelog resmi deepin Linux — update versi terbaru, fitur baru, perbaikan bug, dan peningkatan performa.
permalink: /tag/release-notes/
---
  ...
  <div class="container">
    <div class="tag-page__header">
      ...
      <p class="tag-page__description">
        Release notes dan changelog resmi <strong>deepin Linux</strong>.
        Update versi terbaru, fitur baru, perbaikan bug, dan peningkatan performa.
      </p>
    </div>
    ...
    <div class="tag-filter">
      <div class="tag-filter__bar">
        ...
        <a href="{{ '/tag/release-notes/' | relative_url }}" class="tag-filter__item active">Release Notes</a>
    ...
    <div class="news-grid">
      {% assign filtered_posts = site.posts | where_exp: "post", "post.tags contains 'Release Notes'" | sort: 'date' | reverse %}
      {% for post in filtered_posts %}
      <article class="news-card">
        <div class="news-card__image">
          <div class="news-card__image-placeholder" style="background: linear-gradient(135deg, #1a6dd4, #1250a0);">
    ...
    <div class="news-empty">
      ...
      <h2>Belum ada release notes</h2>
      <p>Konten release notes sedang dipersiapkan. Kunjungi kembali nanti!</p>
    </div>
    {% endif %}
  </div>
</section>
