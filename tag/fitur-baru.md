---
layout: default
title: Tag - Fitur Baru
description: Eksplorasi fitur-fitur baru di deepin Linux — DDE, UOS AI, Treeland, Linyaps, dan inovasi terbaru lainnya.
permalink: /tag/fitur-baru/
---
  ...
  <div class="container">
    <div class="tag-page__header">
      ...
      <p class="tag-page__description">
        Eksplorasi <strong>fitur-fitur baru</strong> di deepin Linux.
        DDE, UOS AI, Treeland, Linyaps, dan inovasi terbaru lainnya.
      </p>
    </div>
    ...
    <div class="tag-filter">
      <div class="tag-filter__bar">
        ...
        <a href="{{ '/tag/fitur-baru/' | relative_url }}" class="tag-filter__item active">Fitur Baru</a>
        <a href="{{ '/tag/event/' | relative_url }}" class="tag-filter__item">Event</a>
      </div>
    </div>

    <div class="news-grid">
      {% assign filtered_posts = site.posts | where_exp: "post", "post.tags contains 'Fitur Baru'" | sort: 'date' | reverse %}
      {% for post in filtered_posts %}
      <article class="news-card">
        <div class="news-card__image">
          <div class="news-card__image-placeholder" style="background: linear-gradient(135deg, #d97706, #b45309);">
    ...
    <div class="news-empty">
      ...
      <h2>Belum ada artikel fitur baru</h2>
      <p>Konten fitur baru sedang dipersiapkan. Kunjungi kembali nanti!</p>
    </div>
    {% endif %}
  </div>
</section>
